...
<dict/>
	...
	do shell script "export PATH=\"/usr/local/bin:$PATH\";/usr/local/bin/wunderline add '" & reminderSubject & "' --list 'Iri' --note '" & reminderURL & "' --due " & theDeadline
